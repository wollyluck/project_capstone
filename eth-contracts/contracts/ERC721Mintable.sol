...
function setContract() public onlyOwner {
...
modifier whenNotPaused {
    require(_paused == false, "Contract is not operational");
    _;
...
modifier paused {
    require(_paused == true, "Contract is operational");
    _;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require (msg.sender == ownerOf(tokenId) || isApprovedForAll(_owner, msg.sender), "Operation not allowed");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require (_exists(tokenId) == false && to != address(0));
